...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public void mirrorHelper(Node<E> curr) {
        if(curr.left == null && curr.right == null)
            return;
        else {
            // swap left and right children
            Node<E> tmp = curr.left;
            curr.setLeft(curr.right);
            curr.setRight(tmp);
            // recursively mirror the children
    ...
    public boolean symmetricHelper(Node<E> leftNode, Node<E> rightNode) {
    ...
    public Node<Integer> LCA(Node<Integer> curr, Node<Integer> x, Node<Integer> y) {
        int currEl = curr.getElement();
        int xEl = x.getElement();
        int yEl = y.getElement();
        if(xEl < currEl && yEl < currEl)
            return LCA(curr.left, x, y);
        if(xEl > currEl && yEl > currEl)
            return LCA(curr.right, x, y);
        else
            return curr;
    }

    public int dist(Node<Integer> p1, Node<Integer> p2) {
        Node<Integer> LCA = LCA((Node<Integer>)root, p1, p2);
        Node<Integer> walk1 = LCA;
        Node<Integer> walk2 = LCA;
        int count = 0;
        while(walk1 != p1) {
            if(walk1.getElement() > p1.getElement())
                walk1 = walk1.left;
            else if(walk1.getElement() < p1.getElement())
                walk1 = walk1.right;

            count++;
        }
        while(walk2 != p2) {
            if(walk2.getElement() > p2.getElement())
                walk2 = walk2.left;
            else if(walk2.getElement() < p2.getElement())
                walk2 = walk2.right;
    ...
    public static void main(String [] args) {
        ...
        */
        ...
        BinaryTreePrinter<Integer> btp1 = new BinaryTreePrinter<Integer>(bt);
        System.out.println(btp1.print());
        bt.mirror();
        System.out.println("new bt inorder: " + bt.size() + " " + bt.inorder());

        BinaryTreePrinter<Integer> btp2 = new BinaryTreePrinter<Integer>(bt);
        System.out.println(btp2.print());
        System.out.println(bt.symmetric());
        LinkedBinaryTree<Integer> lt = new LinkedBinaryTree<Integer>();

        //Direct construction of the tree
        Position<Integer> rootlt = lt.addRoot(25);
        Position<Integer> l1 = bt.addLeft(rootlt, 12);
        Position<Integer> l2 = bt.addRight(rootlt, 31);
        Position<Integer> l3 = bt.addLeft(l1, 2);
        Position<Integer> l4 = bt.addRight(l1, 15);
        BinaryTreePrinter<Integer> ltprint = new BinaryTreePrinter<Integer>(lt);
        System.out.println("lt\n" + ltprint.print());
        System.out.println(lt.symmetric());
        System.out.println(lt.dist((Node<Integer>) l3,(Node<Integer>) l2));
